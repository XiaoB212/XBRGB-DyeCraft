...
public class DyecraftMod implements ModInitializer {
    ...
    public void onInitialize() {
        ...
        // 堆肥概率
        CompostingChanceRegistry.INSTANCE.add(ModItems.RED_DYE_SEEDS, 0.4f);
        CompostingChanceRegistry.INSTANCE.add(ModItems.BLUE_DYE_SEEDS, 0.4f);
        CompostingChanceRegistry.INSTANCE.add(ModItems.GREEN_DYE_SEEDS, 0.4f);
        CompostingChanceRegistry.INSTANCE.add(ModItems.RED_DYE_PLANT, 0.7f);
        CompostingChanceRegistry.INSTANCE.add(ModItems.BLUE_DYE_PLANT, 0.7f);
        CompostingChanceRegistry.INSTANCE.add(ModItems.GREEN_DYE_PLANT, 0.7f);
